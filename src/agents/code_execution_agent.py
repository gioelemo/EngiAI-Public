...
This agent specializes in executing Python code snippets and expressions,
performing calculations, and testing code logic.
"""
...
from src.utils.prompts import CODE_EXECUTION_AGENT_SYSTEM_PROMPT


class CodeExecutionAgent:
    """Agent specialized in executing Python code and performing calculations."""
    ...
    def _llm_call(self, state: MessagesState) -> dict:
        ...
        messages: list[AnyMessage] = [
            SystemMessage(content=CODE_EXECUTION_AGENT_SYSTEM_PROMPT)
        ] + state["messages"]
