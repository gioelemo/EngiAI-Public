"""
Minimal Excalidraw demo - testing in isolation
"""

import streamlit as st

st.set_page_config(
    page_title="Excalidraw Minimal Test",
    page_icon="✏️",
    layout="wide",
)

st.title("✏️ Excalidraw Minimal Test")
st.markdown("Testing Excalidraw in complete isolation")
...
2. Look for logs starting with "EXCALIDRAW MINIMAL"
3. Check if you see the Excalidraw interface above
